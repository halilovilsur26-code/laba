...
Карта знаний игрового разработчика:
```mermaid
mindmap
  root((Игровой разработчик))
    Дизайн
      Идея
      Механики
    Программирование
...
Я дал perplexity промпт "ты карьерный консультант помоги мне стать игровым разработчиком, ответ выдай в формате mermaind mindmap" и вот что он мне на это ответил:
...
Основные функции игрового разработчика:

<br><br>

<img width="1092" height="788" alt="Снимок экрана 2025-12-16 004819" src="https://github.com/user-attachments/assets/7c03d205-f644-4b79-84f6-62bb45d9049c" />

<br><br>

Знания и умения игрового разработчика:

<img width="1092" height="788" alt="Снимок экрана 2025-12-16 004819" src="https://github.com/user-attachments/assets/7988f3de-1df3-45df-acc1-53aed8b34e8e" />

<br><br>

Общая карта:

<img width="1092" height="788" alt="Снимок экрана 2025-12-16 004819" src="https://github.com/user-attachments/assets/4a1d7bc3-17af-44ec-a2ad-c8dbd9d0cbb0" />

<br><br>

Добавим цвета

<img width="1250" height="471" alt="TLF1Ji905BoJy0yz6GqXtWrf-9EcI4ECfMrMYF46nSY10p5UZ8c0nhiLMYcLuY-y_IDdjrRQKWDjIfcPdPbzsxpgwQpNlR3QNTsfLcfAuqYyKPN6kMtQxCnckjKnL7ga5H_GZfQuDWeUFLhB-mVjkCl755Aa7DDSWbRodoq-8HzozwHnAiNKQWKhr5Bf3ZCC" src="https://github.com/user-attachments/assets/49333663-7739-4b5b-8667-6d29ebba3d2e" />
...
orange — центральная роль и блок функций

green — развитие и проектирование

blue — фундамент и логика

purple — код и творческий контент

red — движок и тесты (критичные зоны)

brown — процессы и документация

teal — оптимизация

pink — геймдизайн (эмоции игрока)

gray — командная работа и коммуникации

</kbd>

<br><br>

Дал перплексити промт 

<br><br>

<kbd> 
Действуй как студент, который хочет получить профессию игрового разработчика (программиста). Возьми приложенный файл профстандарта и составь краткий список трудовых функций. Для каждой функции укажи основные необходимые знания и умения в виде названий дисциплин, чтобы студент смог выбрать свою траекторию изучения. Представь результаты в виде таблицы с очень короткими фразами:
первый столбец — трудовая функция (должностные обязанности),
второй столбец — дисциплины для получения знаний и умений, необходимых для этой функции.
...
| ---------------------------------- | ----------------------------------- |
| Разработка игрового кода (A01-A09) | Программирование игр, C#, Unity     |
| Дизайн игровых механик (B01-B08)   | Геймдизайн, алгоритмы ИИ            |
| Графика и анимация (C01-C06)       | 3D-моделирование, Shader, Blender   |
| Тестирование и отладка (D01-D04)   | Тестирование ПО, QA игр 06.022.pdf​ |

<br><br>

Ввел свою диаграмму в яндекс вики

<img width="907" height="303" alt="Снимок экрана 2025-12-16 013816" src="https://github.com/user-attachments/assets/285d6a67-2356-4047-9455-ec2f8347bf4f" />
...
В этой работе я познакомился с одной из популярных нынче технологий работы с диаграммами под названием Diagram as code — «диаграмма как код». Можно сказать, что это развитие технологии облегчённой, упрощённой разметки текста Markdown. Я увидел, что оба инструмента — и Mermaid, и PlantUML — поддерживаются и интегрируются самыми разными платформами разработки и документирования. Попутно я попробовал самые разные подходы и инструменты для запуска программ, в том числе переносимые приложения Portable Applications и контейнеры Docker. Кроме того, я на своём опыте почувствовал необходимость организации хранения разных версий моей диаграммы. 
